...
public abstract class OpenTracingClientBaseTests extends OpenTracingBaseTests {
    ...
    private void testAnnotations() throws InterruptedException {
        ...
        TestSpanTree expectedTree = new TestSpanTree(
                new TreeNode<>(
                        ...
                        new TreeNode<>(
                                new TestSpan(
                                        TestDisabledAnnotatedClass.class.getName()
    ...
    private void testClassOperationName() throws InterruptedException {
        Response response =
                executeRemoteWebServiceRaw(TestServerWebServicesWithOperationName.REST_TEST_SERVICE_PATH_WITH_OP_NAME,
    ...
    private void testAnnotationException() throws InterruptedException {
        ...
        TestSpanTree expectedTree = new TestSpanTree(
                new TreeNode<>(
                        ...
                        new TreeNode<>(
                                new TestSpan(
                                        TestAnnotatedClass.class.getName()
                                                + ".annotatedClassMethodImplicitlyTracedWithException",
                                        tags,
                                        Arrays.asList(logs)))));
    ...
    private void testMultithreadedNestedSpans() throws InterruptedException, ExecutionException {
        ...
        testMultithreadedNestedSpans(TestServerWebServices.REST_NESTED, numberOfCalls, nestDepth, nestBreadth, failNest,
                async);
    }
