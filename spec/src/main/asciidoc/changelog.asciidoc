...
* Exclude transitive dependency on `jakarta.el-api` (https://github.com/eclipse/microprofile-opentracing/pull/196[#196])
...
* Removed `geronimo-atinject` and `jakarta.annotation` dependencies for API module (https://github.com/eclipse/microprofile-opentracing/pull/92[#92])
