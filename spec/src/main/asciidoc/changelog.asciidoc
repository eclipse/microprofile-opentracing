...
* By default excluded MicroProfile Metrics, Health and OpenAPI from tracing (https://github.com/eclipse/microprofile-opentracing/pull/95[#95])
...
* Added server name operation provider (https://github.com/eclipse/microprofile-opentracing/pull/90[#90])
